...
public class CommonUtil {
    // 你账号的APPID
    public static String APPID = "wx3a3cc59073132963";

    // 你账号的APPSECRET
    public static String APPSECRET = "9307382f12eaa1af2909071dc89b83db";
     ...
     * @throws IOException
     */
    public static String sendGet(String url) throws ParseException {
        String result = "";
    ...
    public static Map<String, Object> getJsapiConfig(HttpServletRequest request, String token) {
        ...
        if (queryString != null) {
            ...
            url = queryStringEncode.substring(5);
        } else {
            url = urlString;
        }
